...
Citizen.CreateThread(function()
  while true do
  Citizen.Wait(5)
      if PlayerData.job ~= nil and PlayerData.job.name == 'police' and PlayerData.job.grade >= 4 then
          local player = GetPlayerPed(-1)
          if GetDistanceBetweenCoords(GetEntityCoords(player, true), 429.39, -981.8, 30.7, true) < 10 then
              DrawMarker(1, 429.39, -981.8, 30.7-0.90, 0, 0, 0, 0, 0, 0, 2.0, 2.0, 1.0, 216, 12, 239, 155, 0, 0, 2, 0, 0, 0, 0)
            if GetDistanceBetweenCoords(GetEntityCoords(player, true), 429.39, -981.8, 30.7, true) < 1.5 then
